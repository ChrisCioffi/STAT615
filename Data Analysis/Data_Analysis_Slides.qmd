...
- MLR Model: $College\_GPA = \beta_0 + \beta_1future\_job + \beta_2college\_gpa + \beta_3major\_considering + \beta_4urbanicity + \beta_5family\_income + \beta_6credits + \beta_7school\_type + \beta_8school\_belonging + \epsilon$.
...
- Null Hypothesis: $\beta_4urbanicity$ = $\beta_8school\_belonging$ = 0
...
```{r}
step(MLR_all.reg, direction="both")
```
