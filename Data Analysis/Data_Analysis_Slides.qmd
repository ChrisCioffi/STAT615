...
HSLS_Data |>
  ...
  labs(
    title = "HS GPA vs. College GPA by Desired Education",
    x = "High School GPA",
    y = "College GPA"
  ) +
  theme_bw() +
...
- P-value of 0.331, insufficient evidence to reject the null hypothesis that the values for the betas of these two predictors are not zero.
